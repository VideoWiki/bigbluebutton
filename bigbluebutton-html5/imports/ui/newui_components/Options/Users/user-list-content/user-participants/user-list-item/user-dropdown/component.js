...
import RemoveUserModal from '/imports/ui/newui_components/modal/remove-user/component';
...
class MyUserDropdown extends PureComponent {
  /**
...
MyUserDropdown.propTypes = propTypes;
export default withModalMounter(lockContextContainer(MyUserDropdown));
