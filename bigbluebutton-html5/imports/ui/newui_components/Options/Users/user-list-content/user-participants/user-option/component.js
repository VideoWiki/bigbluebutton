...
import { getUserNamesLink } from '../../../service';
...
class MyUserOptions extends PureComponent {
  constructor(props) {
    super(props);
...
MyUserOptions.propTypes = propTypes;
export default withModalMounter(injectIntl(MyUserOptions));
