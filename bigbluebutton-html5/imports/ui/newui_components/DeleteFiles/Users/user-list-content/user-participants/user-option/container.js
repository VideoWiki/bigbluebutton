...
import MyUserOptions from './component';
...
const MyUserOptionsContainer = withTracker((props) => {
  const {
    users,
    clearAllEmojiStatus,
    intl,
...
MyUserOptionsContainer.propTypes = propTypes;

export default injectIntl(MyUserOptionsContainer);
