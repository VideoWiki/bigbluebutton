...
import TalkingIndicatorContainer from '/imports/ui/newui_components/nav-bar-new/talking-indicator/container';
          ...
          <button
            ...
            >
              <div className={styles.center}>
                {isExpanded && <Icon iconName="left_arrow" className={styles.arrowLeft} />}
