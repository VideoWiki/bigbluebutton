  ...
  render() {
    ...
    const recordingIndicatorIcon = (
      <span data-test="mainWhiteboard" className={cx(styles.recordingIndicatorIcon, (!isPhone || recording) && styles.presentationTitleMargin)}>
        <svg xmlns="http://www.w3.org/2000/svg" height="100%" version="1" viewBox="0 0 20 20">
          <g stroke="#E64980" fill="#E64980" strokeLinecap="square">
            <circle
              fill="#fff"
              strokeWidth="2.5"
              r="7"
            ...
            />
            <circle
              stroke={recording ? '#F00' : '#E64980'}
              fill={recording ? '#F00' : '#E64980'}
              r="3"
              cx="10"
              cy="10"
            />
    ...
    const recordMeetingButton = (
      <div
        ...
        styles.recordingControlON : 
        styles.recordingControlOFF)}
        role="button"
        tabIndex={0}
          ...
          {showButton
            ...
            >
              ...
              >
                {recordingIndicatorIcon}
                {recording
                  ? <div className={styles.recordButton}>{humanizeSeconds(time)}</div> : null}
              </div>
            </div>
          )}
        </div>
