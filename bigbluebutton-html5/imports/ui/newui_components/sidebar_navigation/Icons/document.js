...
function Document(props) {
    ...
    return (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Iconly/Bulk/Document">
            <g id="Document">
                <path id="Path" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83V17.16C3 20.26 4.77 22 7.81 22H16.191C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2Z" className={(sidebarContentPanel === "document") ? styles.iconDark : styles.iconNormal}/>
